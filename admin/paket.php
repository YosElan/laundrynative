                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                            data-bs-target="#editModal<?= $row['id_paket']; ?>">
                            Edit
                        </button>

                        <!-- Modal Edit -->
                        <div class="modal fade" id="editModal<?= $row['id_paket']; ?>" tabindex="-1"
                            aria-labelledby="editModal<?= $row['id_paket']; ?>" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_paket" class="form-control"
                                                id="nama_paket" value="<?= $row['nama_paket']; ?>" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <button type="submit" name="edit_paket" class="btn btn-primary"
                    ...
                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                        data-bs-target="#hapusModal<?= $row['id_paket']; ?>">
                        Hapus
                    </button>

                    <!-- Modal Hapus -->
                    <div class="modal fade" id="hapusModal<?= $row['id_paket']; ?>" tabindex="-1"
                        aria-labelledby="hapusModalLabel<?= $row['id_paket']; ?>" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="koneksi.php?id_paket=<?= $row['id_paket']; ?>"
