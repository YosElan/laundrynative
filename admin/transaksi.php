        ...
        <tr>
            ...
            <td>
                        ...
                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                            data-bs-target="#editModal<?= $row['id_transaksi']; ?>">
                            Edit
                        </button>

                        <!-- Modal Edit -->
                        <div class="modal fade" id="editModal<?= $row['id_transaksi']; ?>" tabindex="-1"
                            aria-labelledby="editModal<?= $row['id_transaksi']; ?>" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="kode_invoice" class="form-control"
                                                id="kode_invoice" value="<?= $row['kode_invoice']; ?>" required>
                                        </div>
                                        <div class="mb-3">
                    ...
                    <button type="button" class="btn btn-danger btn-sm mt-2" data-bs-toggle="modal"
                        data-bs-target="#hapusModal<?= $row['id_transaksi']; ?>">
                        Hapus
                    </button>

                    <!-- Modal Hapus -->
                    <div class="modal fade" id="hapusModal<?= $row['id_transaksi']; ?>" tabindex="-1"
                        aria-labelledby="hapusModalLabel<?= $row['id_transaksi']; ?>" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="koneksi.php?id_transaksi=<?= $row['id_transaksi']; ?>"
