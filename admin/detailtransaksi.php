...
<tbody>
        ...
        <tr>
            ...
            <td>
                        ...
                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                            data-bs-target="#editModal<?= $row['id_detail']; ?>">
                            Edit
                        </button>

                        <!-- Modal Edit -->
                        <div class="modal fade" id="editModal<?= $row['id_detail']; ?>" tabindex="-1"
                            aria-labelledby="editModal<?= $row['id_detail']; ?>" aria-hidden="true">
    ...
    <button type="submit" name="edit_detail" class="btn btn-primary" value="edit">Edit</button>
                    ...
                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                        data-bs-target="#hapusModal<?= $row['id_detail']; ?>">
                        Hapus
                    </button>

                    <!-- Modal Hapus -->
                    <div class="modal fade" id="hapusModal<?= $row['id_detail']; ?>" tabindex="-1"
                        aria-labelledby="hapusModalLabel<?= $row['id_detail']; ?>" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="koneksi.php?id_detail=<?= $row['id_detail']; ?>"
